...
ActiveRecord::Schema[7.0].define(version: 2023_08_29_015554) do
  ...
  create_table 'platformings', force: :cascade do |t|
    ...
    t.index %w[platform_id external_user_id], name: 'index_platformings_on_platform_id_and_external_user_id'
    t.index ['platform_id'], name: 'index_platformings_on_platform_id'
    t.index %w[user_type user_id], name: 'index_platformings_on_user'
  end
